Your Redis setup is mostly correct, but you should make these improvements:

* validate env vars
* use process.env safely
* fix duplicate state edge cases
* add proper timeout/error handling
* improve Redis persistence
* make Telegram alerts cleaner
* ensure Vercel compatibility
* use Next.js API style properly

Here’s the corrected and production-ready expanded version.
